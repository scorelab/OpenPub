(function() {
    ...
    angular
        .module('openpub')
        .controller('pubListController', function(auth, openpubFactory, $firebaseArray, $scope, $mdSidenav, $mdDialog, $state, $mdToast, $stateParams, $location, pubService, pubListCategoryService, pubListService) {
